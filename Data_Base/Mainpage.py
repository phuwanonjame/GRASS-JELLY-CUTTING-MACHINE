...
class Ui_MainPage(object):
    ...
    def setupUi(self, MainPage):
        ...
        self.label_Name.setGeometry(QtCore.QRect(480, 40, 500, 91))
        font = QtGui.QFont()
        ...
        self.label_model.setGeometry(QtCore.QRect(100, 180, 150, 31))
        font = QtGui.QFont()
        font.setFamily("TH SarabunPSK")
        ...
        self.label_owner.setGeometry(QtCore.QRect(1005, 230, 150, 31))
        font = QtGui.QFont()
        font.setFamily("TH SarabunPSK")
        font.setPointSize(20)
        ...
        self.label_order.setGeometry(QtCore.QRect(510, 200, 150, 31))
        font = QtGui.QFont()
        font.setFamily("TH SarabunPSK")
        font.setPointSize(20)
    ...
    def Startbtn(self):     #เริ่มกระบวนการทำงาน
        ...
        if orderq != [] or DataOwner != []:
            ...
            msgBox = QtWidgets.QMessageBox()
            msgBox.setWindowTitle("Error")
            msgBox.setText("ไม่พบข้อมูในคววออร์เดอร์")
            msgBox.exec_()
...
class Stock_ShowWeight(QtWidgets.QDialog):  #โชว์น้ำหนักในคลัง
    def __init__(self):
        ...
        myresult = mycursor.fetchall()
        Salver = myresult [0][:1:2][0]
        cnx.connect
        Stock_Salver=str(Salver)
        Stock_Square=str(Square)
        Stock_Wavy=str(Wavy)
